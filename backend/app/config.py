...
class Settings(BaseSettings):
    ...
    POSTGRES_PASSWORD: str = Field(default="qubot_pass", description="PostgreSQL password")
    ...
    SECRET_KEY: str = Field(
        default="7b0b6d274643c5b59f77f985926719b33100693a0050875e6560934fa47cf494",
    ...
    DEFAULT_LLM_TEMPERATURE: float = Field(default=0.7, description="Default temperature")
    ...
    TELEGRAM_WEBHOOK_URL: str = Field(default="", description="Public webhook URL for Telegram")
    ...
    WHATSAPP_WEBHOOK_VERIFY_TOKEN: str = Field(default="", description="WhatsApp webhook verify token")
    ...
    WORKER_HEARTBEAT_INTERVAL: int = Field(default=10, description="Worker heartbeat interval")
...
# Legacy support for code that imports from config directly
class LegacyConfig:
    """Legacy config wrapper for backwards compatibility"""
...
# Export legacy config for existing code
config = LegacyConfig()
