from sqlalchemy import Column, Integer, String, Boolean, ForeignKey, DateTime, JSON, Text, Enum as SQLEnum
from sqlalchemy.orm import relationship, declarative_base
from datetime import datetime
from .enums import DomainEnum, AgentStatusEnum, TaskStatusEnum, PriorityEnum, MemoryScopeEnum, LlmProviderEnum, ToolTypeEnum, GenderEnum
