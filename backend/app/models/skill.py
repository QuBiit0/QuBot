...
from sqlalchemy import Column, String, Text, Integer, ForeignKey, Boolean, DateTime, JSON, Enum as SQLEnum
...
class SkillParameter(Base):
    ...
    param_type = Column(String(50), nullable=False)  # string, number, boolean, array, object
...
class AgentSkill(Base):
    ...
    permission_level = Column(String(20), default="READ_WRITE")  # READ_ONLY, READ_WRITE, DANGEROUS
...
class SkillResponseSchema(BaseModel):
    ...
    code: Optional[str] = None  # Only return code if user has access
