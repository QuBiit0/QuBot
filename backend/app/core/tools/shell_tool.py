...
class SystemShellTool(BaseTool):
    ...
    def _validate_config(self) -> None:
        ...
        self._allowed_set = {cmd.split()[0] for cmd in self.allowed_commands}
    ...
    def _validate_command(self, command: str) -> tuple[bool, str | None]:
        ...
        _command_prefix = " ".join(parts[:2]) if len(parts) > 1 else parts[0]
    ...
    def _validate_cwd(self, cwd: str | None) -> tuple[bool, str | None]:
