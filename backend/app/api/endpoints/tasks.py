...
async def create_task(
    ...
    task = await service.create_task(
        ...
        assigned_agent_id=UUID(task_data["assigned_agent_id"]) if task_data.get("assigned_agent_id") else None,
        parent_task_id=UUID(task_data["parent_task_id"]) if task_data.get("parent_task_id") else None,
...
async def update_task_status(
    ...
    agent_id = UUID(status_update["agent_id"]) if status_update.get("agent_id") else None
