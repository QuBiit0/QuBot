...
class TaskWorker:
    ...
    def __init__(self):
        ...
        if not REDIS_AVAILABLE:
            raise ImportError("Redis is required for worker. Install with: pip install redis")
...
class TaskQueue:
    ...
    def __init__(self):
        ...
        if not REDIS_AVAILABLE:
            raise ImportError("Redis is required for TaskQueue. Install with: pip install redis")
