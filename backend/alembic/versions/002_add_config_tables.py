...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_config_category_key", "system_config", ["category", "key"], unique=False
    )
    op.create_index(
        op.f("ix_system_config_category"), "system_config", ["category"], unique=False
    )
    op.create_index(
        op.f("ix_system_config_key"), "system_config", ["key"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_config_preset_is_active"), "config_preset", ["is_active"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column(
            "config_key", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False
        ),
        sa.Column(
            "category", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        ...
        sa.Column(
            "change_reason", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        ...
        "config_history",
        ["config_key", "changed_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_config_history_config_key"),
        "config_history",
        ["config_key"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column(
            "environment", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        sa.Column("key", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False),
    ...
    op.create_index(
        op.f("ix_environment_config_environment"),
        "environment_config",
        ["environment"],
        unique=False,
    )
